...
export function buildFeatureFlags(env: AppEnv): FeatureFlags {
  return {
    ...
    contextV2Enabled: env.FEATURE_CONTEXT_V2_ENABLED,
    contextConfidenceEnabled: env.FEATURE_CONTEXT_CONFIDENCE_ENABLED,
    topicEngineEnabled: env.FEATURE_TOPIC_ENGINE_ENABLED,
    affinitySignalsEnabled: env.FEATURE_AFFINITY_SIGNALS_ENABLED,
    moodEngineEnabled: env.FEATURE_MOOD_ENGINE_ENABLED,
    replyQueueEnabled: env.FEATURE_REPLY_QUEUE_ENABLED,
    mediaReactionsEnabled: env.FEATURE_MEDIA_REACTIONS_ENABLED,
