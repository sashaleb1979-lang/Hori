...
export const defaultRuntimeTuning = {
  ...
  FEATURE_ROAST: true,
  FEATURE_CONTEXT_V2_ENABLED: true,
  FEATURE_CONTEXT_CONFIDENCE_ENABLED: true,
  FEATURE_TOPIC_ENGINE_ENABLED: true,
  FEATURE_AFFINITY_SIGNALS_ENABLED: true,
  FEATURE_MOOD_ENGINE_ENABLED: true,
  FEATURE_REPLY_QUEUE_ENABLED: true,
  FEATURE_MEDIA_REACTIONS_ENABLED: false,
  ...
  NATURAL_SPLIT_CHANCE: 0.06,
  NATURAL_SPLIT_COOLDOWN_SEC: 1800,
