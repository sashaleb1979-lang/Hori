...
async function main() {
  const globalFlags = [
    ...
    { key: "context_v2_enabled", enabled: true },
    { key: "context_confidence_enabled", enabled: true },
    { key: "topic_engine_enabled", enabled: true },
    { key: "affinity_signals_enabled", enabled: true },
    { key: "mood_engine_enabled", enabled: true },
    { key: "reply_queue_enabled", enabled: true },
    { key: "media_reactions_enabled", enabled: false },
    { key: "runtime_config_cache_enabled", enabled: true },
    { key: "embedding_cache_enabled", enabled: true },
